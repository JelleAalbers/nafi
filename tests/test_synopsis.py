...
def test_synopsis():
    ...
    assert round(p_obs[0], 4) == 0.0270
    assert round(ll_obs, 1) == 1.8
    assert round(ul_obs, 1) == 15.1
    assert round(brazil[0][0], 1) == 6.6
    assert round(brazil[-1][0], 1) == 3.1
    assert round(brazil[+1][0], 1) == 10.1
